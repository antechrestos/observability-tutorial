...
public record Fridge(Map<FoodStuff, Map<String, AtomicInteger>> stocks) {

    private static final Logger LOGGER = LoggerFactory.getLogger(Fridge.class);

    public Fridge(MeatInitialStock meatInitialStock, CheeseInitialStock cheeseInitialStock) {
        this(Map.of(FoodStuff.meat,
